...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'title' => env('BLOG_DEFAULT_TITLE', 'Kelompok Nisrina'),
    ...
    |--------------------------------------------------------------------------
    */
    'subtitle' => env('BLOG_DEFAULT_SUBTITLE', 'Simple Project Kelompok 3'),
    ...
    |--------------------------------------------------------------------------
    */
    'description' => env('Project Kelompok Berapa Lupa', 'Kelompok Berapa Lupa'),
    ...
    |--------------------------------------------------------------------------
    */
    'author' => env('BLOG_DEFAULT_AUTHOR', 'Markhan'),
